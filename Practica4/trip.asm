...
aumentarContadorTrip macro
    ...
    diez:
        ...
        duno:
        mov conteoTriptongos[1], "1"
        mov conteoTriptongos[2], "0"
        jmp fin
        ddos:
        mov conteoTriptongos[1], "2"
        mov conteoTriptongos[2], "0"
        jmp fin
        dtres:
        mov conteoTriptongos[1], "3"
        mov conteoTriptongos[2], "0"
        jmp fin
        dcuatro:
        mov conteoTriptongos[1], "4"
        mov conteoTriptongos[2], "0"
        jmp fin
        dcinco:
        mov conteoTriptongos[1], "5"
        mov conteoTriptongos[2], "0"
        jmp fin
        dseis:
        mov conteoTriptongos[1], "6"
        mov conteoTriptongos[2], "0"
        jmp fin
        dsiete:
        mov conteoTriptongos[1], "7"
        mov conteoTriptongos[2], "0"
        jmp fin
        docho:
        mov conteoTriptongos[1], "8"
        mov conteoTriptongos[2], "0"
        jmp fin
        dnueve:
        mov conteoTriptongos[1], "9"
        mov conteoTriptongos[2], "0"
        jmp fin
...
escribirReporteTrip macro
    local fin, cicloA, aumentar, aumRet, vocalA, vocalI, cicloE, cicloEE, esC
    reiniciarContadorTrip
    xor di, di
    xor si, si
    cicloA:
